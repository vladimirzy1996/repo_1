...
public class EnglishSnowBallStemmer extends SnowballStemmer {
	...
	private final static EnglishSnowBallStemmer methodObject = new EnglishSnowBallStemmer();

	private final static Among a_0[] = {

			new Among("arsen", -1, -1, "", methodObject), new Among("commun", -1, -1, "", methodObject),
			new Among("gener", -1, -1, "", methodObject) };

	private final static Among a_1[] = {

			new Among("'", -1, 1, "", methodObject), new Among("'s'", 0, 1, "", methodObject),
	...
	private void copy_from(EnglishSnowBallStemmer other) {
	...
	public boolean equals(Object o) {
		return o instanceof EnglishSnowBallStemmer;
	}
	...
	@Override
	public int hashCode() {
		return EnglishSnowBallStemmer.class.getName().hashCode();
	}
